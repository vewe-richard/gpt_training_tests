...
# Create an instance of the model and move it to the accelerator device
model = Net()
model, trainloader = accelerator.prepare(model, trainloader)
...
for epoch in range(10):
    ...
    for i, data in enumerate(trainloader, 0):
        ...
        # Forward + backward + optimize (all on accelerator device)
